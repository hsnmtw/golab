...
function compressToArray(x) { return LZString144.compressToUint8Array(x); }
function decompressFromArray(x) { return LZString144.decompressFromUint8Array(x); }

export { LZString144, compressToArray, decompressFromArray };