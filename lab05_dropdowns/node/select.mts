export default function modernizeSelect(selector : any){
    document.querySelectorAll(selector).forEach(select => {
        select.className = 'hidden'
            ...
            function optionTemplate(x: any,index: any) {
                return `
            ...
            let childOptions : Array<HTMLElement>;
            function init(){
                const template = `
                ...
                button = selectContainer.querySelector<HTMLButtonElement>('button')!;
                childOptions = Array.from(selectContainer.querySelectorAll<HTMLElement>('.child-option'));
                const selectedText = selectContainer.querySelector<HTMLElement>('.selectedText');
                const focusNext = selectContainer.querySelector<HTMLElement>('.focus-next');
                childOptions.forEach((o : HTMLElement,index : number) => o.addEventListener("click", (e : Event) =>{
            ...
            var observer = new MutationObserver(function(mutations) {
                mutations.forEach(function(mutation) {
                    if (mutation.type === "attributes") {
                        ...
                        button.disabled = (mutation.target as HTMLButtonElement).disabled;
                    }
