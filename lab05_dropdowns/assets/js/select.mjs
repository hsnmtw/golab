export default function modernizeSelect(selector) {
    document.querySelectorAll(selector).forEach(select => {
        ...
        function init() {
            ...
            childOptions = Array.from(selectContainer.querySelectorAll('.child-option'));
            const selectedText = selectContainer.querySelector('.selectedText');
            const focusNext = selectContainer.querySelector('.focus-next');
            childOptions.forEach((o, index) => o.addEventListener("click", (e) => {
